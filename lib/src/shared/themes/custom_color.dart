...
const customcolor1 = Color(0xFFC13265);

CustomColors lightCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFFC13265),
  customcolor1: Color(0xFFB02459),
  onCustomcolor1: Color(0xFFFFFFFF),
  customcolor1Container: Color(0xFFFFD9E0),
  onCustomcolor1Container: Color(0xFF3F0019),
);

CustomColors darkCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFFC13265),
  customcolor1: Color(0xFFFFB1C3),
  onCustomcolor1: Color(0xFF66002D),
  customcolor1Container: Color(0xFF8F0042),
  onCustomcolor1Container: Color(0xFFFFD9E0),
);
...
class CustomColors extends ThemeExtension<CustomColors> {
  ...
  CustomColors lerp(ThemeExtension<CustomColors>? other, double t) {
    ...
    return CustomColors(
      sourceCustomcolor1: Color.lerp(
        sourceCustomcolor1,
        other.sourceCustomcolor1,
        t,
      ),
